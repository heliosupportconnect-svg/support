  ...
  return (
    <main className="helios-page">
      ...
      <header className="sticky top-0 z-50 border-b border-slate-100 bg-white/95 shadow-sm backdrop-blur-xl">
        <div className="mx-auto flex min-h-[72px] w-full max-w-[1440px] items-center justify-between gap-4 px-4 py-3 md:min-h-[82px] md:px-8 lg:px-12">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0 leading-tight">
              <div className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-helios-secondary md:text-xs">
                Helios
              </div>

              <div className="truncate text-sm font-extrabold text-slate-900 md:text-xl">
                Sadineni Chowdaraiah
              </div>

              <div className="truncate text-xs font-semibold text-slate-500 md:text-sm">
                Futuristic School
              </div>

              <div className="mt-0.5 truncate text-[9px] font-extrabold uppercase tracking-[0.1em] text-helios-secondary md:text-[11px]">
          ...
          <div className="flex shrink-0 items-center gap-2 md:gap-3">
            <Link
              href="/login"
              className="inline-flex min-h-10 items-center justify-center gap-1.5 rounded-full bg-helios-surface-container px-4 py-2 text-sm font-bold text-slate-800 transition hover:bg-helios-surface-high md:px-5 md:py-2.5 md:text-base"
            >
              <MaterialIcon className="text-[18px]">lock</MaterialIcon>
              <span>Login</span>
            </Link>

            <Link
              href="/register"
              className="inline-flex min-h-10 items-center justify-center gap-1.5 rounded-full bg-helios-orange px-4 py-2 text-sm font-extrabold text-white shadow-sm transition hover:brightness-95 active:scale-[0.98] md:px-6 md:py-2.5 md:text-base"
            >
